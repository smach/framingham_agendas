...
# Load data - moved data processing to agendas_to_geocode.R
# hearings <- readRDS("hearings_with_districts.Rds")
hearings_clean <- readRDS("hearings_clean.Rds")
districts_sf <- readRDS("districts_sf.Rds")
districts_wgs84 <- readRDS("districts_wgs84.Rds")
